...
final class Str
{
    ...
    public function chunkSplit(?int $length = null, ?string $end = null): self
    {
        ...
        if (self::isBinary($this->value())) {
            $chunk = $this->mbChunkSplit($this->value(), $length, $end);
        } else {
    ...
    public function ltrim(?string $character_mask = null): self
    {
        ...
        if (self::isBinary($this->value())) {
            $string = $this->mbLtrim($this->value(), $character_mask);
        } else {
    ...
    {
        if (self::isBinary($this->value())) {
            $rev = $this->mbStrrev($this->value(), $encoding);
        } else {
    ...
    public function rtrim(mixed $character_mask = null): self
    {
        ...
        if (self::isBinary($this->value())) {
            $string = $this->mbRtrim($this->value(), $character_mask);
        } else {
    ...
    {
        if (self::isBinary($this->value())) {
            $shuffle = $this->mbShuffle($this->value());
        } else {
    ...
    public function trim(mixed $character_mask = null): self
    {
        ...
        if (self::isBinary($this->value())) {
            $string = $this->mbTrim($this->value(), $character_mask);
        } else {
