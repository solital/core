...
class Arr
{
     ...
     * @return array
     */
    public static function exceptMultiple(array $array, mixed $keys): array
    {
        static::forgetMultiple($array, $keys);
        return $array;
    }
    ...
    public static function flatten(array $array, $depth = INF): array
    {
        ...
        foreach ($array as $item) {
            $item = $item instanceof ArrayCollection ? $item->all() : $item;
     ...
     * @return void
     */
    public static function forgetMultiple(&$arrays, mixed $keys): void
    {
        $original = &$arrays;
        $keys = (array) $keys;
     ...
     * @return void
     */
    public static function forget(&$array, mixed $keys): void
    {
        $original = &$array;
        $keys = (array) $keys;
     ...
     * @return bool
     */
    public static function has(mixed $array, mixed $keys): bool
    {
        if (is_null($keys)) {
            return false;
        }
     ...
     * @return array
     */
    public static function pluck(array $array, mixed $value, mixed $key = null): array
    {
        $results = [];
     ...
     * @return array
     */
    protected static function explodePluckParameters(mixed $value, mixed $key): array
    {
     ...
     * @return array
     */
    public static function set(&$array, string $key, mixed $value): array
    {
        if (is_null($key)) {
            return $array = $value;
        }
     ...
     * @return array
     */
    public static function sort(array $array, mixed $callback = null): array
    {
        return self::make($array)->sortBy($callback)->all();
    }
